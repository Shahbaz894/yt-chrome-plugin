...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            root_dir = os.path.abspath(os.getcwd())  # Safer than using __file__
            ...
            logger.debug('lgbm_model.pkl model load successfully')
            vectorizer=load_vectorizer(os.path.join(root_dir,'tfidf_vectorizer.pkl'))
            logger.debug('tfidf_vectorizer.pkl model load successfully')
