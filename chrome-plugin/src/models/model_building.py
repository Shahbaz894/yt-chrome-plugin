...
def apply_tfidf(train_data:pd.DataFrame,max_features:int,ngram_range:tuple) -> tuple:
    try:
        ...
        raise
def train_lgbm(X_train:np.ndarray,y_train:np.ndarray,learning_rate:float,max_dep:int,n_extimotors:int) -> lgb.LGBMClassifier:
    try:
        best_model=lgb.LGMClassifier(
